...
const puebloDePanayLogo = "/assets/pdp-logo-invert.png";
...
const ForgotPasswordModal = ({ isOpen, onClose }: ForgotPasswordModalProps) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            await adminAuthApi.forgotPassword(enteredEmail);
            setLoading(false);
            setToastMessage("If an account exists, a password reset link has been sent to your email.");
                        ...
                        <div className="flex flex-col items-center gap-7 z-10">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-2.5 text-white/80 text-[14px] leading-relaxed text-center">
                                    Manage community access, security, and resident requests securely.
                                </p>
                            </div>
                        </div>
