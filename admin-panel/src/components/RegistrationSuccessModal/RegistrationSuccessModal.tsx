...
const RegistrationSuccessModal: FC<RegistrationSuccessModalProps> = ({ isVisible, onClose }) => {
    ...
    return createPortal(
        ...
        >
            ...
            >
                ...
                <h3 className="mb-4 text-2xl font-bold text-zinc-100 tracking-tight">Registration complete!</h3>
                <p className="mx-auto mb-2 text-[14.5px] leading-[1.6] text-zinc-300/80 max-w-[320px]">
                    Please wait for a moment while the admin accepts your registration to receive your credentials.
                </p>
            </div>
        </div>,
        document.body
