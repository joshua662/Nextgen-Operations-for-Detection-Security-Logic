    ...
    return (
        <div className="min-h-screen bg-white dark:bg-zinc-800">
            ...
            >
                ...
                <div className={`flex-1 py-4 ${isCollapsed ? "overflow-visible px-2" : "overflow-y-auto px-3"}`}>
                    {!isCollapsed ? (
                ...
                <div className={`border-t border-zinc-200 dark:border-zinc-700 ${isCollapsed ? "overflow-visible p-2 flex justify-center" : "p-3"}`}>
                    <UserProfileMenu
                        variant="sidebar"
